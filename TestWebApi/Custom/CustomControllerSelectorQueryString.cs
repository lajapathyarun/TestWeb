...
namespace TestWebApi.Custom
{
    ...
    public class CustomControllerSelectorQueryString : DefaultHttpControllerSelector
    {
        private HttpConfiguration _config;
        public CustomControllerSelectorQueryString(HttpConfiguration config) : base(config)
        {
            _config = config;
        }
